...
g++ -o libxilinxlib.so -fpermissive -DK7_TRD -DPM_SUPPORT -shared -lpthread -Wl,-soname,libxilinx.so -I/usr/java/jdk1.8.0_11/include/ -I/usr/java/jdk1.8.0_11/include/linux -I. com_xilinx_ultrascale_jni_DriverInfoGen.cpp threads.cpp -Bstatic -lc -fPIC
