...
export XDMA_CTRL_PATH=$(ROOTDIR)/ctrlplane
...
export DMA_CTRL_FILE=xdma_ctrl
...
export DMA_CTRL_DRIVER_NAME=xdma_ctrl.ko
export SLEEP_TIME=1
...
define compile_ctrlplane_drivers
	echo Compiling CtrlPlane drivers
	$(MAKE) -C $(XDMA_CTRL_PATH) 
endef
...
define clean_ctrlplane_drivers
	echo Cleaning Ctrlplane Drivers
	$(MAKE) -C $(XDMA_CTRL_PATH) clean
endef
...
define insert_ctrlplane_driver
	echo Inserting ControlPlane Driver
	$(INSMOD) $(XDMA_CTRL_PATH)/$(DMA_CTRL_DRIVER_NAME); sleep $(SLEEP_TIME)
	$(MKNOD_CMD) /dev/$(DMA_CTRL_FILE) c $(MKNODCTRL) 0
endef
...
define remove_ctrlplane_driver
	echo Removing CtrlPlane Driver
	$(RMMOD) $(DMA_CTRL_DRIVER_NAME)
	$(RM) -f /dev/$(DMA_CTRL_FILE)
endef
